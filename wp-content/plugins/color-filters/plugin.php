...
if ( get_option( 'EWD_UWCF_WC_Color_Attribute_WC_Field_ID' ) == 0 or get_option( 'EWD_UWCF_WC_Size_Attribute_WC_Field_ID' ) == 0 or get_option( 'elm_color_filters_version' ) != CF_VERSION ) {
