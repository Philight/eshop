...
Tags: custom add to cart button, add to cart button, shop button, woocommerce, quote, buynow
 ...
 * Download woo-custom-cart-button.1.1.zip
 * Unzip
...
User can easily change default add to cart button's label and hyperlink in some simple steps. It gives the ability to sell woocommerce products using third-party platforms like Amazon, Paypal, eBay, Alibaba, etc. and can easily use his / her affiliate links.

== Demo Link ==

<a href="https://woo.hirewebxperts.com/" target="_blank">Click Here</a>
...
- Added image option in shortcode to show or not
- Added Default add to cart button control in settings page
...
- Added option for new tab for buttons
- Compatible with variable and bundle products
- New button in classic editor for shortcode insertion
